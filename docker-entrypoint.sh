...
# Create DB and configure
su postgres -c "sh /var/lib/ktpjs/create-db.sh -d ktp /var/lib/ktpjs/ktp-extensions-ddl_1.sql"
su postgres -c "psql ktp -f /var/lib/ktpjs/ktp-ddl_1.sql"
